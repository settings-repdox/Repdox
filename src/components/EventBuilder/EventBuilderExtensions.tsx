...
interface Props {
  ...
  setResources?: (
    v: Array<{ id: string; title: string; link?: string }>,
  ) => void;
}
          ...
          {speakers && setSpeakers && (
            <div className="space-y-3 pt-4 border-t border-border/50">
              <div className="flex items-center justify-between">
                <Label
                  className={isWorkshop ? "text-purple-600 font-bold" : ""}
                >
            ...
            <CardContent className="pt-6 space-y-4">
              <div className="flex items-center justify-between pb-2 border-b border-border">
                ...
                <Button
                  ...
                  onClick={() =>
                    addItem(resources, setResources, {
                      id: crypto.randomUUID(),
                      title: "",
                      link: "",
                    })
              ...
              <div className="space-y-3">
                {resources.length === 0 && (
                  <p className="text-xs text-muted-foreground">
                    Add links to docs, slides, etc.
                  </p>
                )}
                {resources.map((res, i) => (
                  <div
                    key={res.id || i}
                    className="space-y-1 p-2 bg-muted/20 rounded"
                  >
                    <div className="flex gap-2">
                      ...
                      <Button
                        ...
                        onClick={() => removeItem(resources, setResources, i)}
                    ...
                    <Input
                      ...
                      className="h-8 bg-card/50 text-xs font-mono"
                      value={res.link || ""}
                      onChange={(e) =>
                        updateItem(
                          resources,
            ...
            <CardContent className="pt-6 space-y-4">
              <div className="flex items-center justify-between pb-2 border-b border-border">
                ...
                <Button
                  ...
                  className="h-6 w-6 p-0"
                  onClick={() =>
                    addItem(faqs, setFaqs, { question: "", answer: "" })
                  }
                  aria-label="Add FAQ"
                >
                  <Plus className="w-4 h-4" />
              ...
              <div className="space-y-3 max-h-[300px] overflow-y-auto pr-1">
                ...
                {faqs.map((faq, i) => (
                  <div
                    key={i}
                    className="space-y-1 p-2 bg-muted/20 rounded relative group"
                  >
                    <Input
                      ...
                      value={faq.question}
                      onChange={(e) =>
                        updateItem(faqs, setFaqs, i, "question", e.target.value)
                      }
                    />
                    <Textarea
                      ...
                      value={faq.answer}
                      onChange={(e) =>
                        updateItem(faqs, setFaqs, i, "answer", e.target.value)
                      }
                    />
                    <button
